...
import {deleteStudent, getAllStudents} from "./services/client";
import {
    Layout,
    Menu,
    Breadcrumb,
    ...
    return <Layout style={{minHeight: '100vh'}}>
        <Sider collapsible collapsed={collapsed}
            ...
            <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
                ...
                <SubMenu key="sub1" icon={<UserOutlined/>} title="Users">
                    <Menu.Item key="3">Eya</Menu.Item>
                    <Menu.Item key="4">Houcem</Menu.Item>
                </SubMenu>
        ...
        <Layout className="site-layout">
            ...
            <Footer style={{textAlign: 'center'}}>
                ...
                />
                <Divider>
                        <b>billManagement</b> - Drissi Houcemeddine & Tayari eya
                </Divider>
            </Footer>
        </Layout>
    </Layout>
